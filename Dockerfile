...
RUN apt-get update && apt-get install -y apt-transport-https && apt-get install -y curl 
...
RUN git clone https://github.com/leovitch/redmine_importer redmine_importer && mv redmine_importer /usr/src/redmine/plugins/
